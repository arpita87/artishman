            ...
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              <h1 className="text-xl font-bold leading-tight tracking-tight text-center text-gray-900 md:text-2xl dark:text-white">
                <div className="btn-group">
                  ...
                  <button className="btn shadow-2xl "><Link to='/login'>Login</Link></button>
                  <button className="btn shadow-2xl  bg-blue-gray-200 hover:bg-blue-gray-400 border-0"><Link to='/signup'>Signup</Link></button>
                </div>
              </h1>
              <form className="space-y-4 md:space-y-6" action="#">
                ...
                <button
                  type="submit"
                  className="w-full text-black bg-gradient-to-r from-blue-gray-400 to-gray-200  hover:bg-teal-500  font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 "
                >
                  Log in
                </button>
